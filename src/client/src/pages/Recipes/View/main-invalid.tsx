    ...
    return (
        <div className="flex flex-col items-center gap-8 mt-16">
            <div className="flex flex-col lg:flex-row items-center gap-8">
                ...
                <h1 className="text-4xl md:text-6xl text-nutrifit-tertiary">Invalid</h1>
            </div>

            <Card className="max-w-[90vw] md:max-w-[60vw] lg:max-w-[45vw] p-2 border-nutrifit-tertiary">
                <CardHeader>
                ...
                <CardContent className="space-y-4">
                    ...
                    <Separator className="bg-nutrifit-tertiary"/>
                    <p>
                    ...
                    <div className="flex items-end justify-center gap-3">
                        <div className="flex flex-col gap-1">
                            ...
                            <Input id="recipe-id" placeholder="Enter ID" type="number" className="w-[100%] border-nutrifit-tertiary" value={recipeId} onChange={(e) => setRecipeID(e.target.value)}/>
                        </div>
                        <Button className="self-end bg-nutrifit-tertiary" onClick={navigateToRecipe}>Navigate</Button>
                    </div>
                    <Separator className="bg-nutrifit-tertiary" />
                    <p>
                    ...
                    <div className="flex justify-center">
                        <Button onClick={() => navigate(`/recipes/search`)} className="bg-nutrifit-tertiary">
